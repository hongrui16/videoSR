...
class Config:
    ...
    # resume_from: str = "/scratch/rhong5/weights/temp_training_weights/sdx4_fri_dstcm/REDS/20251109_015116_5012783/fri_dstcm_best.pt"  # e.g., ./ckpts_sdx4_fri_dstcm/fri_dstcm_step_10000.pt
    ...
    use_lr_interp_for_ref: bool = False
    use_lora: bool = False
    use_injection: bool = True
    num_ref_frames: int = 3  # number of frames used to build conditional hr frames, 2 or 3
