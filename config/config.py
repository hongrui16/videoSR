...
class Config:
    ...
    log_dir: str = 'zlog'
    # resume_from: str = "/scratch/rhong5/weights/temp_training_weights/sdx4_fri_dstcm/Vimeo-90K/20251104_025746_5002471/fri_dstcm.pt"  # e.g., ./ckpts_sdx4_fri_dstcm/fri_dstcm_step_10000.pt
    ...
    unet_weights_precision: str = "fp16"  # "fp16" | "bf16" | "fp32"
    data_precision: str = "fp16"  # "fp16" | "bf16" | "fp32"
